...
function setup() {
  ...
  sliderValue=document.getElementById('defaultSlider');
  sliderValue.addEventListener('change',writeToCharacteristic);
}
  ...
  function readCharacteristics(characteristics) {
    ...
    characteristics[0].readValue()
      .then(data => {
        ...
        sliderValue.value = ledState;
        dataDiv.innerHTML="Bri:"+" "+ledState;
